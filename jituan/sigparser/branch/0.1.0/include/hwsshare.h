...
const UINT MAX_SDTP_MSG_LEN         = 800;        //SDTP协议消息最大长度
const UINT MIN_SDTP_MSG_LEN         = 9;           //SDTP协议消息最小长度
const UINT MSG_HEAD_LEN             = 9;           //SDTP协议消息包头长度
...
//send to sugw
const UINT MAX_SEQ_NUM_LEN   = 49;
const UINT MIN_SEND_DATA_LEN = 36;
const UINT MAX_SEND_DATA_LEN = 79;
